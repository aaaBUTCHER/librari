...
CREATE TABLE `lojtari51835` (
  ...
  `Skuadra_id51835` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lojtari51835` VALUES (1,'Emri 1','Mbiemri 1',1),(2,'Emri 2','Mbiemri 2',2);
...
INSERT INTO `ndertesa212261491` VALUES (2,'Blla blla','2023-11-28'),(3,'Blla bllnnnnnnn','2023-12-26'),(4,'Blla bllnnnnnnn','2023-12-26');
...
INSERT INTO `skuadra51835` VALUES (1,'Skuadra 1'),(2,'Skuadra 2');
...
-- Dump completed on 2023-12-13 21:37:12
